...
Source0  : https://gitlab.gnome.org/World/libcloudproviders/-/archive/0.3.6/libcloudproviders-0.3.6.tar.gz
...
%prep
%setup -q -n libcloudproviders-0.3.6
cd %{_builddir}/libcloudproviders-0.3.6
pushd ..
cp -a libcloudproviders-0.3.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710944384
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcloudproviders.so.0.3.6
/usr/lib64/libcloudproviders.so.0
/usr/lib64/libcloudproviders.so.0.3.6
