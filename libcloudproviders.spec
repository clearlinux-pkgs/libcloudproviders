...
Version  : 0.3.0
Release  : 1
URL      : https://gitlab.gnome.org/World/libcloudproviders/uploads/e97a550ebbf85e753c4df5692a86b39d/libcloudproviders-0.3.0.tar.xz
Source0  : https://gitlab.gnome.org/World/libcloudproviders/uploads/e97a550ebbf85e753c4df5692a86b39d/libcloudproviders-0.3.0.tar.xz
...
%prep
%setup -q -n libcloudproviders-0.3.0
cd %{_builddir}/libcloudproviders-0.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663958328
...
%files data
%defattr(-,root,root,-)
/usr/lib64/girepository-1.0/CloudProviders-0.3.0.typelib
...
/usr/lib64/libcloudproviders.so.0.3.0
